...
\documentclass[11pt,twocolumn]{article}
	...
	in time $O(NlogN)$. The fast Fourier transform (FFT) makes it possible for us to generate a fractal terrain
	...
	values create rougher landscapes. Though we can change the relative roughness of the terrain, it will still have
	a relatively smooth surface in comparison to the previous methods we described.  
