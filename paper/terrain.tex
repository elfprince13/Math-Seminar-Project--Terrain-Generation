...
\documentclass[11pt,twocolumn]{article}
	...
	\S \ref{sec:FFT} ,which describes how to use the Fast Fourier transformation to create fractal landscapes as well.
	...
	Finally, \S \ref{sec:multifractal} describes the multi-fractal and its application to terrain generation. A multi-fractal
	...
	This is because the Diamond Square Algorithm is an improvement upon the Midpoint Displacement Algorithm.
	...
	Though, they were not formally defined until 1975. It was also not until 1986 that the Diamond Square Algorithm was formally introduced
