...
\item The multi fractal technique uses four parameters to create a generated landscape: $\alpha$, $C_{1}$ $S$, and $R$. 
\begin{itemize}
\item The first variable, $\alpha$, is used to determine the occurrence of peaks or singularities throughout the terrain.
\item The second variable, $C_{1}$, is used to contrail the roughness of the terrain
